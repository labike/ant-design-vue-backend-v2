...
<template>
  ...
  >
        ...
        <div>
          ...
          <a-form-item>
            <a-input
              ...
              type="text"
              placeholder="QQ号码"
              v-decorator="['qq', {rules: [{ required: true, message: '请输入QQ号码' }], validateTrigger: ['change', 'blur']}]"
            ></a-input>
          </a-form-item>
        </div>
      </a-form>
    ...
    <template slot="footer">
      <a-button key="forward" :loading="confirmLoading" type="primary" @click="handleChangeSub(currentStep)">提交</a-button>
    </template>
  </a-modal>
</template>
